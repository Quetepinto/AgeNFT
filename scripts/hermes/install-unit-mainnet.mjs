#!/usr/bin/env node
/**
 * Instala integración Hermes para Unit-Mainnet (MVP):
 * - skill agenft-core (mainnet)
 * - scripts en ~/.hermes/scripts/
 * - cron Doctor cada 15m
 */
...
const SKILL_SRC = join(REPO, 'runtime/pack/unit-mainnet/skills/agenft-core/SKILL.md');

const CRON_NAME = 'agenft-unit-mainnet-doctor';
...
console.log('\nInstalación Hermes Unit-Mainnet OK.');
console.log('Verificar: cd runtime && npm run hermes:verify:mainnet');
