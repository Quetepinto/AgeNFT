...
```
     ...
     ┌───────────┬───────────┼───────────┬───────────┬───────────┐
     ▼           ▼           ▼           ▼           ▼           ▼
  Web3        Wallet       App         Chat        Social      Juego
  market      (icono)      propia      (texto)     (Zora…)     (NPC)
```
...
Mapa detallado: **[`social-habitats-zora.md`](social-habitats-zora.md)**

| Red | Prioridad | Perfil agente soberano |
|-----|-----------|------------------------|
| **Zora** (Base) | ★★★★★ | Creator Coin + posts desde TBA |
| **Farcaster** | ★★★★☆ | Casts desde wallet |
| **Lens** | ★★★☆☆ | Perfil wallet Polygon |
| **Telegram / Discord** | ★★★★☆ | Bot (ya en plan) |
| **Nostr** | ★★★★★ | npub propia del agente |
| **Matrix** | ★★★★☆ | Bot federado / self-host |
| **Simplex** | ★★★★☆ | Máxima privacidad, sin ID público |
| **WhatsApp** | owner opt-in | No default protocolo |
| **X / Bluesky** | ★★★☆☆ | Cuenta bot dedicada |
...
| **Livepeer** (stream/CDN vídeo) | Entrega HLS/WebRTC presencia | P1–P3 playback | ★★★★☆ (Fase 4.5+) |
...
| **Zora** (Base) | Social creadores + Creator Coins | P0–P1 posts; ingresos TBA | ★★★★★ |
| **Base App** | Social Coinbase + Zora integrado | P0–P1 | ★★★★☆ |
