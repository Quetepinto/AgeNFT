...
>
> **Última revisión:** 2026-07-15 · **Lab:** Unit-1 #115 (Sepolia legacy) · **Objetivo:** Base mainnet

**Migración:** [`mainnet-migration.md`](mainnet-migration.md) · **Cadena:** [`chain-base-mainnet.md`](../decisions/chain-base-mainnet.md) · **VIMS:** [`vims-vs-agenft-registry.md`](vims-vs-agenft-registry.md)

---

## ⚠️ Lab vs producto (Jul-2026)

| | Lab (hoy) | Producto (objetivo) |
|---|-----------|---------------------|
| Cadena | Base **Sepolia** | Base **mainnet** |
| Mint | VIMS agent.vims.com | **ageNFT Registry** propio |
| Pagos x402 | Mainnet USDC (EOA lab) | Mainnet USDC (**TBA**) |
| Unit-1 #115 | Referencia transfer | **Unit-mainnet** nuevo mint |

**No pagar servicios en Sepolia** — tx402/toju operan en mainnet only.
