...
function renderOrganStatusPanel(node) {
  ...
  root.innerHTML = `
    ...
    ${
      stepsHtml
        ? `<details class="lab-organ-steps"><summary>Completar configuración</summary><ol>${stepsHtml}</ol></details>`
        : ''
    }
  `;
}
...
function renderNodeEditor() {
  ...
  root.innerHTML = `
    ...
    <div class="lab-organ-intro">
      <span class="lab-blurb-label">Qué es</span>
      <p class="lab-organ-blurb">${escapeHtml(nodeBlurb(node.id))}</p>
    </div>
