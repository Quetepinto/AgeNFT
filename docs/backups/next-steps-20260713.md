...
| Hecho ✅ | Pendiente ⏸ |
|---------|-------------|
| Unit-1 mint + manifiesto | Hermes integrado de verdad (2.4) |
| Pago x402 cerebro (EOA) | Pago desde TBA |
...
| # | Tarea | Por qué |
|---|-------|---------|
| 1 | **Hermes `agenft-core` operativo** — manifiesto + budget antes de cada inferencia | Une motor y cuerpo |
| 2 | **Cron Doctor lite** — probe tx402 cada 15 min, log estado | Primer “autonomía” |
| 3 | **dApp estática mínima** — imagen NFT, saldo TBA, budget, último chat | Primera cara pública |
